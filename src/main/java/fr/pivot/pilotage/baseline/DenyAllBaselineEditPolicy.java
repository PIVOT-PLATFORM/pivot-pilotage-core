...
/**
 * Fail-closed default {@link BaselineEditPolicy} (US22.4.9) — always denies, wired as the only bean
 ...
 * rather than guessing or permitting everyone. Replace this bean with a real
 * PMO/chef-de-projet-checking implementation once the starter is consumable;
 * {@link BaselineController} requires no change.
 */
@Component
public class DenyAllBaselineEditPolicy implements BaselineEditPolicy {
